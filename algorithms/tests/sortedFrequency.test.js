...
test(`There's 2 3s, so 2`, () => {
  expect(sortedFrequency.sortedFrequency([1, 1, 2, 2, 2, 2, 3, 3], 3)).toBe(2)
})
test(`There's 2 1s, so 2`, () => {
  expect(sortedFrequency.sortedFrequency([1, 1, 2, 2, 2, 2, 3], 1)).toBe(2)
})
test(`There's 1 1, so 1`, () => {
  expect(sortedFrequency.sortedFrequency([1, 2, 2, 2, 2, 2, 3], 1)).toBe(1)
})
test(`There's 0 1, so -1`, () => {
  expect(sortedFrequency.sortedFrequency([2, 2, 2, 2, 2, 3], 1)).toBe(-1)
})
